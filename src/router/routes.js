...
export default [
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/create-order'),
  // },
  // {
  //   path: '/order-buy/list',
  //   name: 'Đơn mua hàng',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order-buy/order-buy-list'),
  // },
  // {
  //   path: '/order-buy/:id',
  //   name: 'Đơn mua hàng',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order-buy/order-buy-detail'),
  // },
  // {
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order/order-seller/order-seller-list'),
  // },
  // {
  //   path: '/order/order-buyer-email',
  //   name: 'Đơn hàng',
  //   meta: {
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order/order-buyer/order-buyer-email'),
  // },
  // {
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order/order-buyer/order-buyer-detail'),
  // },
  // {
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('./views/order/order-buyer/order-buyer-list'),
  // },
  // {
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/cart-list'),
  // },
  // {
  //   path: '/past-cart',
  //   name: 'Cart',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/cart-past'),
  // },
  //
  // {
  //   path: '/finance',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/finance'),
  // },
  // {
  //   path: '/order-retail',
  //   name: 'Đơn lẻ',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/order'),
  // },
  // {
  //   path: '/order-wholesale',
  //   name: 'Đơn sỉ',
  ...
  //     authRequired: true,
  //   },
  //   component: () => import('../app/page/customer/order-detail'),
  // },
  // {
  //   path: '/create-retail',
  //   name: 'Chi tiết',
  ...
  //   meta: { authRequired: true },
  //   component: () => import('./views/contacts/group-permission')
  // },
  // {
  //   path: '/contacts/grid',
  //   name: 'User Grid',
