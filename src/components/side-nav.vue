...
<template>
  ...
  <div id="sidebar-menu">
    ...
    <ul id="side-menu" class="metismenu list-unstyled">
      ...
      <li>
        <router-link tag="a" to="/supplier/list" class="side-nav-link-ref">
          <i class="bx bx-home-circle"></i>
      ...
      <li>
        ...
        <ul class="sub-menu" aria-expanded="false">
          <li>
            <router-link tag="a" to="/product/list" class="side-nav-link-ref">Sản phẩm</router-link>
          </li>
          <li>
            <router-link tag="a" to="/taxes/list" class="side-nav-link-ref">Thuế</router-link>
          </li>
          <li>
            <router-link tag="a" to="/origin/list" class="side-nav-link-ref">Xuất xứ</router-link>
          </li>
          <li>
            <router-link tag="a" to="/unit/list" class="side-nav-link-ref">Đơn vị tính</router-link>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="sub-menu" aria-expanded="false">
          <li>
            <router-link tag="a" to="/order/retail" class="side-nav-link-ref">Đơn lẻ</router-link>
          </li>
          <li>
            <router-link tag="a" to="/order/wholesale" class="side-nav-link-ref">Đơn sỉ</router-link>
          </li>
          <li>
            <router-link tag="a" to="/order/auction" class="side-nav-link-ref">Đơn đấu giá</router-link>
          </li>
          <li>
            <router-link tag="a" to="/order/paymentpartner" class="side-nav-link-ref">Đơn thanh toán hộ</router-link>
          </li>
          <li>
            <router-link tag="a" to="/order/shippingpartner" class="side-nav-link-ref">Đơn vận chuyển</router-link>
          </li>
        </ul>
      </li>

      <li>
        <router-link tag="a" to="/order-buy/list" class="side-nav-link-ref">
          <i class="bx bx-home-circle"></i>
      ...
      <li>
        <router-link tag="a" to="/transaction/list" class="side-nav-link-ref">
          <i class="bx bx-home-circle"></i>
          <span>Giao dịch</span>
        </router-link>
      </li>
      ...
      <li>
        <router-link tag="a" to="/user/list" class="side-nav-link-ref">
          <i class="bx bx-home-circle"></i>
      ...
      <li>
        ...
        <ul class="sub-menu" aria-expanded="false">
          <li>
            <router-link tag="a" to="/contacts/group-permission" class="side-nav-link-ref">Nhóm/ Phân quyền</router-link>
          </li>
          <li>
